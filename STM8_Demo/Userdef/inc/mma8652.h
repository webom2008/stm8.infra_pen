...
#define MMA8652_I2C            I2C1
#define MMA8652_ADDR           0x3A /*uint8_t(0x1D << 1)*/
#define MMA8652_I2C_SPEED      50000 

#define MMA8652_I2C_CLK                     CLK_Peripheral_I2C1
#define MMA8652_I2C_SCL_PIN                 GPIO_Pin_1                  /* PC.01 */
#define MMA8652_I2C_SCL_GPIO_PORT           GPIOC                       /* GPIOC */
#define MMA8652_I2C_SDA_PIN                 GPIO_Pin_0                  /* PC.00 */
#define MMA8652_I2C_SDA_GPIO_PORT           GPIOC                       /* GPIOC */
#define MMA8652_I2C_SMBUSALERT_PIN          GPIO_Pin_7                  /* PC.04 */
#define MMA8652_I2C_SMBUSALERT_GPIO_PORT    GPIOB                       /* GPIOC */
